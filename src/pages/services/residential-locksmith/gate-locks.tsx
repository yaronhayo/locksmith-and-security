...
import { gateLocksServiceSchema, gateLocksFaqs, gateLocksRelatedServices, gateLocksFaqSchema } from '@/components/services/gate-locks/GateLocksSchema';
...
const GateLocks = () => {
  return (
    <ServiceLayout
      ...
      schemas={[
        { type: 'service', data: gateLocksServiceSchema },
        { type: 'faq', data: gateLocksFaqSchema }
      ]}
