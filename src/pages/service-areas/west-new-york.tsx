...
import ServiceAreaHero from "@/components/service-areas/west-new-york/ServiceAreaHero";
import ServicesList from "@/components/service-areas/west-new-york/ServicesList";
...
const schema = {
  ...
  "review": {
    ...
    "reviewBody": "Excellent emergency locksmith service in West New York. Fast response and professional work."
  }
};
...
const features = [
  {
    ...
    description: "Available around the clock for all your locksmith needs in West New York."
  },
  {
    icon: Shield,
  ...
  },
  {
    icon: Phone,
    title: "Fast Response",
    description: "15-30 minute response time throughout West New York."
  }
];
  ...
  return (
    ...
    >
      <div className="container mx-auto px-4 py-12">
        ...
        <div className="mt-16">
          <ReviewsSection location="West New York" />
        </div>
