...
import ServiceAreaHero from "@/components/service-areas/union-city/ServiceAreaHero";
import ServicesList from "@/components/service-areas/union-city/ServicesList";
...
const schema = {
  ...
  "review": {
    ...
    "reviewBody": "Excellent emergency locksmith service in Union City. Fast response and professional work."
  }
};
...
const features = [
  {
    ...
    description: "Available around the clock for all your locksmith needs in Union City."
  },
  {
    icon: Shield,
  ...
  },
  {
    icon: Phone,
    title: "Fast Response",
    description: "15-30 minute response time throughout Union City."
  }
];
  ...
  return (
    ...
    >
      <div className="container mx-auto px-4 py-12">
        ...
        <div className="mt-16">
          <ReviewsSection location="Union City" />
        </div>
