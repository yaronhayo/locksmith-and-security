  ...
  return (
    ...
    >
      <div className="flex items-center gap-2 mb-6">
        ...
        <h2 className="text-2xl md:text-3xl font-bold">Serving Union City, NJ</h2>
      </div>
      <p className="text-lg text-gray-700 mb-6">
        At Locksmith & Security LLC, we provide comprehensive locksmith services throughout Union City. 
