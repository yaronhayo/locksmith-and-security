...
export const autoCaseStudies: CaseStudy[] = [
  {
    ...
    result: "The customer received a fully functional replacement key at significantly less cost than the dealership quote. The entire process was completed promptly, allowing them to keep their work schedule without disruption.",
