...
export const emergencyCaseStudies: CaseStudy[] = [
  {
    ...
    solution: "Our emergency locksmith arrived promptly after the call. Using specialized non-destructive entry tools, we were able to open the sophisticated lock without causing damage to the door or lock mechanism.",
  ...
  },
  {
    ...
    solution: "Our mobile locksmith unit arrived quickly. Using professional entry tools, we safely accessed the vehicle without damaging the lock or triggering the alarm system.",
    result: "The family regained access to their vehicle quickly, avoiding potential distress for the children. We also provided advice on preventative measures for the future.",
