...
const EmergencyCallout = () => {
  return (
    <div className="bg-primary/5 p-8 rounded-lg my-8">
      <h2 className="text-3xl font-bold mb-4">Need Emergency Lock Change Service?</h2>
      <p className="text-lg mb-6">
        Don't compromise your business security. Our commercial locksmith team is ready 24/7.
      </p>
