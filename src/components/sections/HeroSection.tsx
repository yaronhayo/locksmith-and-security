          ...
          <div className="lg:w-1/2 space-y-6 lg:space-y-8 text-white">
            ...
            >
              <div className="flex items-center gap-3">
                <div className="relative h-[1.2em] inline-flex items-center min-w-[120px] md:min-w-[110px]">
                ...
                <span className="whitespace-nowrap ml-[120px] md:ml-[120px]">Locksmith</span>
              </div>
