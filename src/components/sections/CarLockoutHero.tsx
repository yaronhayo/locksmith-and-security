        ...
        <div className="grid lg:grid-cols-2 gap-8 lg:gap-12 items-start lg:items-center">
          ...
          >
            ...
            <p className="text-xl text-white/90 mb-8">
              Professional car locksmith service in North Bergen available 24/7. 
              Damage-free entry by our certified automotive specialists.
            </p>
          ...
          >
            <div className="bg-white rounded-2xl p-6 lg:p-8 shadow-2xl">
              <div className="text-center mb-6">
                ...
                <p className="text-gray-600 mt-2">Professional automotive locksmith assistance</p>
              </div>
              <BookingForm />
            </div>
          </motion.div>
