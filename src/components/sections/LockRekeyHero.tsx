        ...
        <div className="grid lg:grid-cols-2 gap-12 items-center py-8">
          ...
          >
            <h1 className="text-4xl md:text-5xl font-bold text-white mb-6">
              Professional Lock Rekey Services
            </h1>
            <p className="text-xl text-white/90 mb-8">
              Expert lock rekeying services in North Bergen. Keep your existing locks while getting new keys. 
              Perfect for new homeowners, landlords, or after losing keys. Available 24/7.
            </p>
          ...
          >
            <div className="bg-white rounded-2xl p-8 shadow-2xl">
              <div className="text-center mb-6">
                <h2 className="text-2xl font-bold text-gray-900">Schedule Lock Rekey Service</h2>
                <p className="text-gray-600 mt-2">Professional service guaranteed</p>
              </div>
              <BookingForm />
            </div>
          </motion.div>
