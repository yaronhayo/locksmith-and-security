                ...
                <CardContent className="p-0">
                  ...
                  <div className="bg-gray-50 p-6 pt-4 flex flex-col items-center">
                    ...
                    <div className="inline-block">
                      <Link to={service.link} className="inline-flex items-center px-4 py-2 bg-[#F97316] hover:bg-[#F97316]/90 text-white hover:text-black rounded-md font-medium transition-colors">
                        {service.cta}
