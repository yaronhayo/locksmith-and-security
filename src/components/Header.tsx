        ...
        <div className="flex items-center justify-between h-20">
          ...
          <nav className={`absolute top-20 left-0 w-full transform transition-transform duration-300 lg:static lg:w-auto lg:translate-y-0 lg:bg-transparent ${isMenuOpen ? 'translate-y-0' : '-translate-y-full'} ${isScrolled ? 'bg-white' : 'bg-primary/90 lg:bg-transparent'} lg:block ${isMenuOpen ? 'block' : 'hidden'}`}>
            <ul className="flex flex-col lg:flex-row space-y-4 lg:space-y-0 lg:space-x-8 p-4 lg:p-0">
              <li><a href="/services" className="text-lg hover:text-secondary transition-colors">Services</a></li>
              <li><a href="/service-areas" className="text-lg hover:text-secondary transition-colors">Service Areas</a></li>
              <li><a href="/faq" className="text-lg hover:text-secondary transition-colors">FAQ</a></li>
              <li><a href="/reviews" className="text-lg hover:text-secondary transition-colors">Reviews</a></li>
              <li><a href="/about" className="text-lg hover:text-secondary transition-colors">About</a></li>
              <li><a href="/contact" className="text-lg hover:text-secondary transition-colors">Contact</a></li>
            </ul>
          </nav>

          <div className="flex items-center space-x-4">
            <div className="hidden md:flex flex-col items-end">
              <span className="text-sm text-gray-600">On Call 24/7</span>
