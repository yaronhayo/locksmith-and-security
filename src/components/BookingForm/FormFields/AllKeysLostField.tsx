...
const AllKeysLostField = ({ isSubmitting, onChange, value }: AllKeysLostFieldProps) => {
  return (
    <div className="space-y-2">
      <Label htmlFor="all_keys_lost" className="font-medium">All Keys Lost?</Label>
      <RadioGroup
        defaultValue={value}
      ...
      >
        <div className="flex items-center space-x-2">
          ...
          <Label htmlFor="all_keys_lost_yes" className="cursor-pointer">Yes</Label>
        </div>
        <div className="flex items-center space-x-2">
          <RadioGroupItem value="no" id="all_keys_lost_no" />
          <Label htmlFor="all_keys_lost_no" className="cursor-pointer">No</Label>
        </div>
      </RadioGroup>
    </div>
  );
